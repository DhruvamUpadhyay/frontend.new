...
const srcDir = 'A:\\FBP_frontend\\src\\pages';
const destDir = 'a:\\FBP\\frontend\\src\\app';

const routes = {
  'marketing/LandingPage.tsx': '(marketing)/page.tsx',
  'marketing/Login.tsx': '(marketing)/login/page.tsx',
  'marketing/Signup.tsx': '(marketing)/signup/page.tsx',
  'student/StudentOverview.tsx': '(dashboard)/student/page.tsx',
  'student/StudentCourses.tsx': '(dashboard)/student/courses/page.tsx',
  'student/StudentTests.tsx': '(dashboard)/student/tests/page.tsx',
  'student/StudentCounselling.tsx': '(dashboard)/student/counselling/page.tsx',
  'student/StudentNotes.tsx': '(dashboard)/student/notes/page.tsx',
};
...
function processFile(content) {
  ...
  newContent = newContent.replace(/export\s+const\s+([A-Za-z0-9_]+)\s*=\s*\([^)]*\)\s*=>/g, 'export default function $1()');
